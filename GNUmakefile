...
man: dok-release
	...
	perl -pi.bak -e "s/\[ /\[/g;s/E\\\\['a]/g;s/E\\\\['e]/g" $(MAN_PAGE); \
	perl -pi.bak -e "s/E\\\\[:o]/g" $(MAN_PAGE); \
...
pcre/dftables.exe:       pcre/dftables.c pcre/maketables.c pcre/pcre.h pcre/internal.h pcre/config.h
		$(CC) -o pcre/dftables.exe $(CFLAGS) pcre/dftables.c
